...
**Numbering**: sequential 001.md, 002.md, etc. Tasks are renamed to GitLab issue IIDs after sync — do not hard-code dependencies by filename, use the `depends_on` array.
